...
//  G4double translateY  = -137.6*mm;    // translate all detectors on Y axis for the beam to hit in the middle of the sensors
  G4double translateY  = -126.8*mm;    // translate all detectors on Y axis for the beam to hit in 26 pad (counting from the bottom pad
//and on the bottom there are the shortest pads)
